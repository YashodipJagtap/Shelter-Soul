...
import Gemini from '../Gemini/Gemini'; // Updated import path
    ...
    <>
        ...
        <div className="flex flex-wrap items-center justify-between w-full px-4 py-2 lg:py-4">
          ...
          <div className="flex items-center space-x-3 lg:order-2">
            ...
            <button
              ...
              className="btn btn-primary hidden sm:flex rounded-xl"
      ...
      {showGemini && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="fixed inset-0 bg-black bg-opacity-50" onClick={() => setShowGemini(false)}></div>
          <div className="flex items-center justify-center min-h-screen px-4">
            <div className="relative bg-base-100 rounded-lg shadow-xl w-full max-w-2xl p-4" onClick={(e) => e.stopPropagation()}>
              <button
              ...
              <Gemini onClose={() => setShowGemini(false)} />
            </div>
          </div>
        </div>
      )}
